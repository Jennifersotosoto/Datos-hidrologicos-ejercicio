...
hist(inp[, 2], 
     ...
     main = "Clases de agua por día, contra del agua de caudal en el río Estrella")
...
hist(inp[,3], 
     ...
     xlab = "Rango absoluto",
     ylab = "Caudal Ml por día",
     main = "Clases de agua por día, contra del agua de caudal en el río Banano")
...
plot(MAQ_Banano, ylim = c(100,3000), col= "orange", main= "Valores anules de los caudales")
